...
Now, however, I have changed fields and at the beginning of February 2022, I started studying for a vocational qualification in information and communication technology, specialising in welfare technology. I completed this degree in about 1.5 years and received my papers in October 2023. I also started in August 2023 in my current profession as a technical support person. In this job, I use my own Linux operating system, which suits me more than well, because now I get to deal with things that I have been doing for the last twenty years on a daily basis.
...
At first these current pages were hosted on [Github](https://github.com) using the [Hugo](https://gohugo.io/) site generator. Nowadays the site has been completely rebuilt and is also hosted on [Github](https://github.com). These pages are of course a bit more laborious to maintain, but on the other hand they work faster and are more secure, because the pages are static and there is no way to log into the site the same way as would be done on a [WordPress.org](https://wordpress.org/) server. 

However, the idea of maintaining the sites has not changed from before, because I still intend to continue writing about these personal experiences while this site and these writings serve as a checklist for myself of the installations I have made, if and when I need to go back to an old installation later.
